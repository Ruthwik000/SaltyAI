...
import { predictSearchZone } from "@/lib/operations-api";
...
export default function LostFishermanPage() {
  ...
  const [targetType, setTargetType] = React.useState("craft");
  ...
  const [predictionSource, setPredictionSource] = React.useState("demo");
  const [predictionReason, setPredictionReason] = React.useState();
  ...
  const handleComputeDrift = async (e) => {
    e.preventDefault();
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="trawler">
                      Disabled Motorized FRP / Trawler (32ft)
                    </option>
                    <option value="raft">
                      Inflatable Marine Life Raft (High Leeway)
                    </option>
                  </select>
                </div>
            ...
            <CardContent className="space-y-5 pt-4 font-sans text-xs sm:space-y-6">
              ...
              <div className="flex flex-col justify-between gap-3 rounded-xl border border-sky-200 bg-sky-50/70 p-3 font-sans text-zinc-950 sm:flex-row sm:items-center sm:gap-4 sm:p-4">
                <div className="min-w-0">
                  ...
                  <span className="mt-1 block text-[11px] leading-relaxed text-zinc-600 sm:text-xs">
                    Net displacement <strong>{datumResult.netDriftDistanceNM} NM</strong>{" "}
                    along <strong>{datumResult.netDriftBearing}</strong>
                  </span>
                </div>
                ...
                <div className="flex shrink-0 items-baseline gap-2 border-t border-sky-200 pt-2 sm:block sm:space-y-1 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0 sm:text-right">
                  <span className="text-[10px] text-zinc-500 sm:block">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2 font-sans text-xs sm:grid-cols-3 sm:gap-3">
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-2.5 sm:p-3">
                    ...
                    <div className="text-sm font-bold tabular-nums text-zinc-900 sm:text-base">
                      {datumResult.windLeewaySpeed}
                    </div>
                  ...
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-2.5 sm:p-3">
                    ...
                    <div className="text-sm font-bold tabular-nums text-zinc-900 sm:text-base">
                      {datumResult.currentSpeed}
                    </div>
                    <span className="text-[10px] text-zinc-500 block">
                      Geostrophic Vector: 048°
                    </span>
                  </div>
                  ...
                  <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-2.5 sm:p-3">
                    ...
                    <div className="text-sm font-bold tabular-nums text-zinc-900 sm:text-base">
                      {datumResult.tideInfluence}
                    </div>
                    <span className="text-[10px] text-zinc-500 block">
                      Ebb Tide Mass Transport
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 rounded-xl border border-zinc-200 bg-zinc-50/70 p-3 text-xs sm:p-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <Badge
                    variant="minimal"
                    className="font-sans text-[10px] bg-emerald-50 text-emerald-700 border-emerald-200"
                  >
                    IAMSAR Level 1
                  </Badge>
                </div>
                ...
                <p className="text-[11px] text-zinc-500 leading-relaxed font-sans">
                  Deploy surface search units along Datum axis. Visual sweep width
                  estimated at 0.8 NM under current sea state ({location.waveHeight}m
                  waves, {location.weather.visibility}km visibility).
                </p>
              </div>
                ...
                <div className="divide-y divide-zinc-100 border border-zinc-200 rounded-lg overflow-hidden font-sans text-[11px]">
                  <div className="flex flex-col gap-0.5 bg-white p-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-2">
                    <span className="font-semibold text-zinc-900">
                      Matsya-Kuber IV (Mechanized)
                    </span>
                    <span className="text-zinc-500">4.2 NM from datum • VHF Ch-16</span>
                  </div>
                  <div className="flex flex-col gap-0.5 bg-white p-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-2">
                    <span className="font-semibold text-zinc-900">
                      ICGS Varuna (Patrol Craft)
                    </span>
                    <span className="text-zinc-500">
                      8.9 NM from datum • SOG 18.5 kts
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 pt-2 sm:flex-row sm:flex-wrap">
                <Button
                  ...
                  onClick={() =>
                    alert(
                      `SAR Operations Briefing PDF compiled for Incident ${incidentId}`
                    )
                  }
                >
