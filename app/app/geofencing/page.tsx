  ...
  return (
    <div className="space-y-6">
        ...
        <div className="p-4 rounded-xl border border-amber-300 bg-amber-50/50 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs font-sans">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-sm text-zinc-950">
                  Proximity Caution: Vessel &quot;Velankanni Matha&quot; (IND-TN-11-MO-3012)
                </span>
              ...
              <p className="text-xs text-zinc-600 mt-0.5">
                Vessel has crossed into the 5.0 Nautical Mile caution buffer zone of the India-Sri Lanka International Maritime Boundary Line.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Button
              ...
              onClick={() => alert("Simulated VHF Ch-16 Warning broadcast to vessel skipper.")}
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-xs">
        <Card className="p-4">
          <span className="text-zinc-400 uppercase text-[10px] block">Tracked Boundaries</span>
          <div className="text-2xl font-bold text-zinc-950 my-1">{geofenceZones.length} Zones</div>
          <span className="text-[11px] text-zinc-500 font-sans">1 IMBL, 2 Marine Parks, 1 Naval Gunnery</span>
        </Card>

        <Card className="p-4">
          <span className="text-zinc-400 uppercase text-[10px] block">Monitored Vessels</span>
          <div className="text-2xl font-bold text-zinc-950 my-1">{activeVessels.length} Online</div>
          <span className="text-[11px] text-emerald-600 font-sans">3 Clear, 1 Caution Buffer</span>
        </Card>

        <Card className="p-4">
          <span className="text-zinc-400 uppercase text-[10px] block">Active Buffer Zone</span>
          <div className="text-2xl font-bold text-zinc-950 my-1">5.0 NM</div>
          <span className="text-[11px] text-zinc-500 font-sans">Automated sound/SMS perimeter</span>
        </Card>
      </div>
                  ...
                  <CardContent className="pt-3 space-y-2 text-xs font-sans">
                    ...
                    <div className="pt-1 flex items-center gap-3 font-sans text-[10px] text-zinc-400">
                      ...
                      {zone.points.slice(0, 2).map((pt, i) => (
                        <span key={i} className="bg-zinc-100 text-zinc-700 px-1.5 py-0.5 rounded">
                          {pt.lat}°N, {pt.lon}°E
                        </span>
                      ))}
                    </div>
            ...
            <CardContent className="pt-4 space-y-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <span className="font-sans text-[10px] text-zinc-500">{v.regNumber}</span>
                    </div>
                    <Badge
                      variant="minimal"
                      className={
                  ...
                  <div className="flex items-center justify-between font-sans text-[11px]">
                    ...
                    <span className="text-zinc-900">{v.sogKnots} kts ({v.headingText})</span>
                  </div>
                </div>
              ))}
              ...
              <div className="pt-2">
                <Button
                  ...
                  onClick={() => alert("Geofence perimeter sync request sent to Coast Guard coastal radar.")}
                >
