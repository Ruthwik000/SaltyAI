  ...
  const hourlyData = [
    {
      ...
      wave: location.waveHeight,
      rain: 10,
      swell: location.swellHeight,
      status: "Safe",
    },
    {
      hour: "10:00",
      temp: location.weather.temp + 0.8,
      wind: location.windSpeed + 1,
      wave: location.waveHeight,
      rain: 15,
      swell: location.swellHeight,
      status: "Safe",
    ...
    {
      hour: "12:00",
      temp: location.weather.temp + 1.6,
      wind: location.windSpeed + 3,
      wave: location.waveHeight + 0.2,
      rain: 25,
      swell: location.swellHeight + 0.1,
      status: "Safe",
    },
    {
      hour: "14:00",
      temp: location.weather.temp + 1.2,
      wind: location.windSpeed + 4,
      wave: location.waveHeight + 0.4,
      rain: 30,
      swell: location.swellHeight + 0.2,
      status: "Moderate",
    },
    {
      hour: "16:00",
      temp: location.weather.temp + 0.4,
      wind: location.windSpeed + 2,
      wave: location.waveHeight + 0.3,
      rain: 20,
      swell: location.swellHeight + 0.2,
      status: "Safe",
    },
    {
      hour: "18:00",
      temp: location.weather.temp - 0.6,
      wind: location.windSpeed - 1,
      wave: location.waveHeight + 0.1,
      rain: 15,
      swell: location.swellHeight + 0.1,
      status: "Safe",
    },
    ...
    {
      hour: "22:00",
      temp: location.weather.temp - 1.8,
      wind: location.windSpeed - 3,
      wave: location.waveHeight,
      rain: 5,
      swell: location.swellHeight,
  ...
  const sevenDayOutlook = [
    {
      ...
      tempMax: Math.round(location.weather.temp + 1),
      tempMin: Math.round(location.weather.temp - 3),
      windMax: location.windSpeed + 4,
      waveMax: location.waveHeight + 0.3,
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3 lg:grid-cols-6">
        ...
        <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
          ...
          <div className="my-1.5">
            <div className="font-sans text-lg font-bold tabular-nums text-zinc-950 sm:text-2xl">
              {location.windSpeed}{" "}
              <span className="text-xs font-normal font-sans text-zinc-500">kts</span>
            </div>
            <span className="font-sans text-[10px] text-zinc-500 sm:text-[11px]">
        ...
        <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
          ...
          <div className="my-1.5">
            <div className="font-sans text-lg font-bold tabular-nums text-zinc-950 sm:text-2xl">
              {location.waveHeight}{" "}
              <span className="text-xs font-normal font-sans text-zinc-500">m</span>
            </div>
            <span className="font-sans text-[10px] text-zinc-500 sm:text-[11px]">
        ...
        <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
          ...
          <div className="text-[10px] font-sans text-zinc-400">Kallakkadal: None</div>
        </Card>
        ...
        <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
          ...
          <div className="my-1.5">
            <div className="font-sans text-lg font-bold tabular-nums text-zinc-950 sm:text-2xl">
              ...
              <span className="text-xs font-normal font-sans text-zinc-500">m/s</span>
            </div>
            <span className="font-sans text-[10px] text-zinc-500 sm:text-[11px]">
        ...
        <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
          ...
          <div className="font-sans text-[10px] text-emerald-600">Steady Trend</div>
        </Card>
        ...
        {role === "researcher" && (
          <>
            ...
            <Card className="flex flex-col justify-between p-2.5 sm:p-3.5">
              ...
              <div className="font-sans text-[10px] text-zinc-400">
                Wavelength{" "}
                {((9.81 * location.wavePeriod ** 2) / (2 * Math.PI)).toFixed(0)} m
              </div>
            </Card>
                ...
                {hourlyData.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="mt-1.5 flex items-center justify-between gap-1 border-t border-zinc-200/40 pt-1 font-sans text-[9px] sm:mt-2 sm:text-[10px]">
                      ...
                      <span
                        className={
                          item.status === "Safe" ? "text-emerald-400" : "text-amber-400"
                        }
                      >
                        ●
                      </span>
                  ...
                  <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-zinc-600 sm:gap-3 sm:text-xs">
                    <span>
                      ...
                      <strong className="text-zinc-950">
                        {currentHour.wave.toFixed(1)}m SWH
                      </strong>
                    </span>
                    <span>•</span>
                    <span>
                      Wind:{" "}
                      <strong className="text-zinc-950">{currentHour.wind} kts</strong>
                    </span>
                    <span>•</span>
                    <span>
                      Swell:{" "}
                      <strong className="text-zinc-950">{currentHour.swell}m</strong>
                    </span>
                    <span>•</span>
                    <span>
                      Precipitation Risk:{" "}
                      <strong className="text-zinc-950">{currentHour.rain}%</strong>
                    </span>
                  </div>
                </div>
              ...
              {sevenDayOutlook.map((d, i) => (
                ...
                >
                  <div className="flex items-center gap-3 sm:w-48 sm:gap-4">
                    <span className="w-20 shrink-0 font-semibold text-zinc-900 sm:w-24">
                      {d.day}
                    </span>
        ...
        <CardContent className="pt-4">
          <div className="grid grid-cols-2 gap-2 text-center font-sans text-xs sm:grid-cols-4 sm:gap-3">
            <div className="rounded-lg border border-zinc-200 bg-zinc-50 p-2.5 sm:p-3">
              ...
              <span className="text-[13px] font-bold tabular-nums text-zinc-900 sm:text-sm">
                08:42 AM
              </span>
