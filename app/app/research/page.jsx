  ...
  if (role === "fisherman") {
    return (
      <div className="mx-auto my-12 max-w-xl space-y-4 rounded-xl border border-zinc-200 bg-white p-8 text-center">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-[2px] bg-zinc-100 text-zinc-600">
          <Database className="h-6 w-6" />
        </div>
        <h2 className="text-xl font-bold text-zinc-950">Research &amp; Data</h2>
        <KnowMore>
          <p>Dataset exploration and exports are set up for the researcher and operator consoles. Your work lives in Fishing Zones, Risk &amp; Safety and your trip tracker.</p>
        </KnowMore>
