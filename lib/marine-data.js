export const marineLocations = [
  ...
  // Coastal harbours from the SALTY harbour table (backend/ports.py). Live
  // data loads for each position; the values below are only the offline
  // fallback, copied from the nearest location above.
  {
    id: "port-blair",
    name: "Port Blair",
