...
export function LandingWorkflow() {
  return (
    <section
      id="workflow"
      className="border-b border-zinc-200/80 bg-zinc-950 py-20 text-white sm:py-24"
    >
      <div className="mx-auto grid max-w-5xl gap-12 px-4 sm:px-6 md:grid-cols-[1fr_1.2fr] md:items-center">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-relaxed text-zinc-400">
            The local agent can interpret a question, choose an approved data tool, and
            return a grounded answer. You keep the query, source, and returned records in
            view.
          </p>
          <Link
            href="/app/ai-agent"
