 ...
 */
export function AgentContextChip({ context, onDetach }) {
  return (
        ...
        <div className="flex min-w-0 items-start gap-2">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 font-sans text-[10px] leading-snug text-indigo-900/70">
              {context.variable}
              {context.unit ? ` (${context.unit})` : ""} · {context.region.minLat}–
              {context.region.maxLat}°N, {context.region.minLon}–{context.region.maxLon}°E
