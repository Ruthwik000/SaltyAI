    ...
    <Card className="border-zinc-200">
      ...
      <CardContent className="pt-4 space-y-4">
        <p className="text-xs text-zinc-600 leading-relaxed">
          Remote sensing synthesis for <strong>{location.name}</strong> indicates an
          active coastal upwelling signature. Strong thermal boundary detected at{" "}
          {location.lat.toFixed(1)}°N with chlorophyll-a spike of {location.chlorophyll}{" "}
          mg/m³.
        </p>
