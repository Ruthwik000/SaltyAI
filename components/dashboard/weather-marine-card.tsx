      ...
      <CardContent className="pt-4 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs font-sans">
          ...
          <div className="p-3 rounded-xl border border-zinc-200/80 bg-zinc-50/60 space-y-1">
            ...
            <div className="text-base font-bold text-zinc-950">
              {location.windSpeed} <span className="text-xs font-normal text-zinc-600">kts</span>
            </div>
            <div className="text-[11px] text-zinc-600">
              Direction: <span className="font-semibold text-zinc-900">{location.windDirection}</span> ({location.windDegrees}°)
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl border border-zinc-200/80 bg-zinc-50/60 space-y-1">
            ...
            <div className="text-base font-bold text-zinc-950">
              {location.waveHeight}m <span className="text-xs font-normal text-zinc-600">SWH</span>
            </div>
            <div className="text-[11px] text-zinc-600">
              Period: <span className="font-semibold text-zinc-900">{location.wavePeriod}s</span> • Swell: {location.swellHeight}m
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl border border-zinc-200/80 bg-zinc-50/60 space-y-1">
            ...
            <div className="text-[11px] text-zinc-600 truncate">
              High: <span className="font-semibold text-zinc-900">{location.nextHighTide.split(" ")[0]}</span> • {location.currentSpeed} m/s
            </div>
          </div>
        </div>
