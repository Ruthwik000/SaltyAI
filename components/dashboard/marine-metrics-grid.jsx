          ...
          <>
            ...
            <Card className="p-3 sm:p-4 flex flex-col justify-between hover:border-zinc-300 transition-colors">
              <div className="flex items-center justify-between text-[10px] sm:text-xs font-sans text-zinc-500">
                <span className="font-medium uppercase leading-tight tracking-wide">
                  {t("m.popularFish")}
                </span>
            ...
            <Card className="p-3 sm:p-4 flex flex-col justify-between hover:border-zinc-300 transition-colors">
              ...
              <div className="pt-2 border-t border-zinc-100 flex items-center justify-between gap-2 text-[10px] font-sans text-zinc-400">
                <span
                  ...
                  title={marketData.priceUpdateNote}
                >
            ...
            <Card className="p-3 sm:p-4 flex flex-col justify-between hover:border-zinc-300 transition-colors">
              ...
              <div className="pt-2 border-t border-zinc-100 flex items-center justify-between gap-2 text-[10px] font-sans text-zinc-400">
                <span className="min-w-0 flex-1 truncate">
                  {schoolData.distanceBearing.split("•")[0].trim()}
                </span>
          ...
          <>
            ...
            {role === "operator" ? (
              <Card className="p-3 sm:p-4 flex flex-col justify-between hover:border-zinc-300 transition-colors">
                <div className="flex items-center justify-between text-xs font-sans text-zinc-500">
                  <span className="uppercase font-medium tracking-wide leading-tight">
                    Disaster Prediction
                  </span>
                  <AlertTriangle
                    className={`h-4 w-4 ${
                      operatorDisaster.severity === "Severe" ||
                      operatorDisaster.severity === "Critical"
                        ? "text-rose-600"
                        : "text-amber-600"
                    }`}
                  />
            ...
            <Card className="p-3 sm:p-4 flex flex-col justify-between">
              ...
              <div className="my-2">
                <div className="text-lg sm:text-3xl font-bold font-sans tracking-tight text-zinc-950">
                  {location.windSpeed}{" "}
                  <span className="text-sm font-sans font-normal text-zinc-500">kts</span>
                </div>
            ...
            <Card className="p-3 sm:p-4 flex flex-col justify-between">
              ...
              <div className="my-2">
                <div className="text-lg sm:text-3xl font-bold font-sans tracking-tight text-zinc-950">
                  {location.waveHeight}{" "}
                  <span className="text-sm font-sans font-normal text-zinc-500">m</span>
                </div>
                <div className="flex flex-wrap items-center gap-x-1.5 gap-y-0.5 text-[10px] sm:text-[11px] text-zinc-500 mt-1 leading-snug">
              ...
              <div className="pt-2 border-t border-zinc-100 flex items-center justify-between gap-2 text-[10px] font-sans text-zinc-400">
                ...
                <span
                  className={
                    location.waveHeight > 2.0 ? "text-amber-600" : "text-emerald-600"
                  }
                >
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">
              Live wholesale APMC auction rates, daily price modifications, and morning
              catch clearance.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
                  ...
                  {marketData.items.map((item, idx) => (
                    <tr key={idx} className="hover:bg-zinc-50/80">
                      ...
                      <td className="py-2.5 px-3 font-semibold text-zinc-950">
                        ₹{item.pricePerKg}{" "}
                        <span className="text-[10px] font-normal text-zinc-500">/kg</span>
                      </td>
                      <td className="py-2.5 px-3">
                        <span
            ...
            <div className="p-3 rounded-lg bg-zinc-50 border border-zinc-200 text-xs text-zinc-600 space-y-1">
              ...
              <p>
                {marketData.benchmarkSpecies} and export grade catches are seeing active
                bidding. Boats landing before 09:30 IST secure the best auction premiums.
              </p>
            </div>
          </div>
        </DialogContent>
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3 rounded-lg bg-emerald-50 border border-emerald-200 flex items-center justify-between">
              <div>
                ...
                <span className="text-xl font-bold text-emerald-950">
                  {schoolData.biomassSurge} Biomass Aggregation
                </span>
              </div>
            ...
            <div className="p-3 rounded-lg bg-zinc-50 border border-zinc-200 space-y-1">
              <span className="text-[10px] uppercase font-semibold text-zinc-500 block">
                Satellite Environmental Trigger
              </span>
            ...
            <p className="text-[11px] text-zinc-500 italic">{schoolData.schoolAlert}</p>
          ...
          <div className="space-y-4 pt-2 text-xs">
            ...
            <div className="pt-2 flex justify-end gap-2">
              ...
              <Link href="/app/alerts">
                <Button
                  size="sm"
                  className="text-xs h-8 bg-zinc-950 text-white hover:bg-zinc-800"
                >
