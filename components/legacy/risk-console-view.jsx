...
export function RiskConsoleView() {
  ...
  const [vesselType, setVesselType] = React.useState("trawler");
  ...
  const handleEvaluate = (e) => {
    ...
    setTimeout(() => {
      ...
      const baseScore =
        vesselType === "craft" ? 54 : vesselType === "motorized" ? 38 : 22;
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-600 max-w-xl leading-relaxed">
              Composite index generated from significant wave height (
              {location.waveHeight}m), wind vectors ({location.windSpeed} kts{" "}
              {location.windDirection}), and swell steepness. Mechanized trawlers and
              motorized craft are cleared for standard offshore operations.
            </p>
          </div>
        </div>
            ...
            <CardContent className="pt-4">
              <form onSubmit={handleEvaluate} className="space-y-3.5 text-xs font-sans">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="trawler">
                      Mechanized Wooden/Steel Trawler (48ft)
                    </option>
                    <option value="longliner">
                      Deep-Sea Commercial Longliner (65ft+)
                    </option>
                  </select>
                </div>
                ...
                >
                  ...
                  <span>
                    {isEvaluating ? "Computing Invariants..." : "Evaluate Route Risk"}
                  </span>
                </Button>
              </form>
              ...
              <div className="mt-4 pt-4 border-t border-zinc-100 space-y-3">
                ...
                <div className="space-y-1.5 text-xs">
                  ...
                  {calculatedTripRisk.routeHazards.map((hz, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-2 text-zinc-600 text-[11px]"
                    >
