...
export function Accordion({
  ...
  return (
    <AccordionContext.Provider value={{ openItems, toggleItem }}>
      <div className={cn("divide-y divide-zinc-200/80 border-y border-zinc-200/80", className)}>
        {children}
      </div>
...
export function AccordionItem({
  ...
  return (
    <AccordionItemContext.Provider value={{ value }}>
      <div className={cn("border-b border-zinc-200/60 last:border-b-0", className)}>{children}</div>
